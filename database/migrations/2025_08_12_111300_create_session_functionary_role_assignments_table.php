...
return new class extends Migration {
    public function up(): void {
        Schema::create('session_functionary_role_assignments', function (Blueprint $t) {
            ...
            $t->unsignedTinyInteger('slot')->default(1); // Speaker 1, Speaker 2, Evaluator 1, etc.
            $t->text('notes')->nullable();
            $t->timestamps();

            $t->unique(['club_session_id', 'functionary_role_id', 'slot']);
        });
    }

    public function down(): void {
        Schema::dropIfExists('session_functionary_role_assignments');
    }
};
